...
public class SelectableRoundedImage extends ImageView {
    ...
    public SelectableRoundedImage(Context context) {
        super(context);
    }

    public SelectableRoundedImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectableRoundedImage(Context context, AttributeSet attrs, int defStyle) {
